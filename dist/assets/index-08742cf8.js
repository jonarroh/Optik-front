(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();const a="https://279d-177-228-33-76.ngrok.io/Optik",l=document.getElementById("login");l.addEventListener("click",async function(){localStorage.setItem("vistaActual","");const t=await d(document.getElementById("contrasenia").value),e={datosUsuario:JSON.stringify({nombre:document.getElementById("nombre").value,contrasenia:t.toString()})};l.classList.add("is-loading");const s=await(await fetch(`${a}/api/login/ingresar2`,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams(e)})).json();if(console.log(s),s.error){l.classList.remove("is-loading"),i("error","Usuario o contraseña incorrectos");return}localStorage.setItem("currentUser",JSON.stringify(s)),localStorage.setItem("vistaActual","inicio"),window.location.href="modulos/"});function i(t,e){Swal.mixin({toast:!0,position:"center",showConfirmButton:!0,timer:3e3,timerProgressBar:!0}).fire({icon:t,title:e})}async function d(t){const r=new TextEncoder().encode(t),s=await crypto.subtle.digest("SHA-256",r);return Array.from(new Uint8Array(s)).map(c=>c.toString(16).padStart(2,"0")).join("")}class h extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
      ...
      ${this.getStyles()}
    `,e}getStyles(){return`
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-person",h);class p extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-lock",p);class m extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-home",m);class g extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-eye",g);class u extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-update",u);class w extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-delete",w);class x extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-check",x);class v extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
  ...
  <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1" width="32" height="32"/>
    ...
    * {
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-clean",v);class y extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
  ...
  `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-save",y);class f extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-search",f);class C extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
...
<path d="M174.8,66H142V45.778C142,21.639,122.361,2,98.223,2h-0.445C73.639,2,54,21.639,54,45.778V66H21.2L2,258h192L174.8,66z
	...
	s6-2.687,6-6v-9.784c3.872,2.125,6.5,6.239,6.5,10.964C148.5,101.09,142.9,106.68,136,106.68z"/>
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("buy-icon",C);class b extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("glass-icon",b);class M extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 ...
 <path d="M118,31v194l128,29V2L118,31z M130,40.59l104-23.57v221.96l-104-23.57V40.59z M2,30v224h39v-30h12
	 ...
	 c4.04-0.908,7.038-4.216,7.038-8.27c0-4.934-4.43-8.983-9.763-9.023C173.813,128.881,169.655,132.703,169.655,137.439z"/>
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-test",M);class T extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-material",T);class L extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-box",L);class S extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path id="XMLID_1456_" d="M60,60.7V79c0,2.2-1.6,4-3.8,4H4c-2.2,0-4-1.8-4-4V13c0-2.2,1.8-4,4-4h52.2c2.2,0,3.8,1.8,3.8,4v18.3
	...
	c0.8,0.8,1.8,1.2,2.8,1.2c1,0,2.1-0.4,2.8-1.2l15.7-15.8C92.4,47.1,92.4,44.6,90.8,43z"/>
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("icon-exit",S);class H extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
    ...
    `}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("qualite-text",H);class E extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}getTemplate(){const e=document.createElement("template");return e.innerHTML=`
		...
		`}render(){this.shadowRoot.appendChild(this.getTemplate().content.cloneNode(!0))}connectedCallback(){this.render()}}customElements.define("coso-icon",E);
